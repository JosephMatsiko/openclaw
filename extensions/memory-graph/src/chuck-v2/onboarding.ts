...
export function familyMemberSurfaceCatalog(
  ...
  const members: Omit<FamilyMemberSurfaceProfile, "status" | "countsAsIndependentFamily">[] = [
    ...
    },
    {
      ...
      role: "primary",
      notes: ["shared Max account; Incognito lease protocol; source-heavy research"],
    },
    {
      family: "perplexity",
      ...
      role: "child",
      notes: ["personal account may be present; browser fallback; same Perplexity family"],
    },
    {
      family: "perplexity",
      ...
      label: "Comet browser",
      role: "cousin",
      notes: ["shared Max account; browser/action surface; same Perplexity family"],
    },
    {
      family: "perplexity",
